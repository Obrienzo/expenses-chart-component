  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-red-100">
      <article className="max-w-80 m-5 h-fit">
        <section className="text-neutral-50 flex justify-between bg-red-500 p-5 mb-5 rounded-lg">
          <div>
            <p className="font-light text-xs">My balance</p>
            <p className="font-medium text-xl">$921.48</p>
          </div>
        ...
        <section className="bg-neutral-50 p-5 rounded-lg">
          <h1 className="mb-8 text-brown-950 font-medium text-xl">Spending - Last 7 days</h1>
          {/* Adding  the component of daily expenses for the week */}
          ...
          <div className="mt-7 pt-5 flex justify-between items-end text-xs sm:text-sm font-normal text-brown-400 border-t border-t-zinc-200">
            <div>
              <p>Total this month</p>
              <h2 className="font-medium text-brown-950 text-4xl">$478.33</h2>
            </div>
            <div className="text-end">
              <p className="text-brown-950 text-sm font-medium">+2.4%</p>
              <p>from last month</p>
            </div>
          </div>
        </section>
